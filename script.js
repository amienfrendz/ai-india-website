document.addEventListener('DOMContentLoaded', function () {
    ...
    function pickVoice() {
        ...
        voices.forEach(function (voice) {
            ...
            if (!preferredVoice && (lang.indexOf('en-in') === 0 || name.indexOf('india') !== -1 || name.indexOf('indian') !== -1)) {
